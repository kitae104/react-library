...
export const LeaveALeaview: React.FC<{ submitReview: any }> = (props) => {

    const [starInput, setStarInput] = useState<number>(0);  // 별 갯수(1~5)
    const [displayInput, setDisplayInput] = useState<boolean>(false);  // 리뷰 입력창 표시 여부
    const [reviewDescription, setReviewDescription] = useState<string>('');  // 리뷰 내용
