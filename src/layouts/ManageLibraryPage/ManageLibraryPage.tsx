...
export const MangeLibraryPage: React.FC<{}> = () => {

    const { authState } = useOktaAuth();
    const navigate = useNavigate();

    const [changeQuantityOfBooksClick, setChangeQuantityOfBooksClick] = useState<boolean>(false);
            ...
            <div className='mt-5'>
                ...
                <nav>
                    <div className='nav nav-tabs' id='nav-tab' role='tablist'>
                        <button onClick={addBookClickFunction}
                            className='nav-link active' id='nav-add-book-tab' data-bs-toggle='tab'
                        ...
                        <button onClick={changeQuantityOfBooksClickFunction}
                            className='nav-link' id='nav-quantity-tab' data-bs-toggle='tab'
                            data-bs-target='#nav-quantity' type='button' role='tab' aria-controls='nav-quantity'
                            aria-selected='true'>
                            Change quantity
                        </button>
                        <button onClick={messageClickFunction}
                ...
                <div className='tab-content' id='nav-tabContent'>
                    ...
                    <div className='tab-pane fade' id='nav-quantity' role='tabpanel' aria-labelledby='nav-quantity-tab'>
                        {changeQuantityOfBooksClick ? <>Chanage quantity</> : <></>}
                    </div>
